...
10. Create a new folder, put the script in that folder, and create a new file called 'data.json.' Paste the JSON code into this file.<br> (Simply, keep both files in same folder).
