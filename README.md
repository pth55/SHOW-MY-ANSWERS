...
8. <b>Now Download the Tool/Software from [HERE!](https://github.com/pth55/SHOW-MY-ANSWERS/releases/download/v2/show_my_answers.exe) and just Double click that executable to open the actual software.<br></b>
